...
I write here about things that I find interesting and things that I'm currently learning about. Note taking is great but writing about things in public is much better. I can finally have a place ([this blog](https://prasanthkarri.dev)) in a corner of the internet where I can play around with tech (used [astro](https://astro.build) to build [this blog](https://prasanthkarri.dev)), meet other interesting people, record my daily learnings (like - today I learned), gather feedback and improve myself.
...
If you are interested in following along, do bookmark this site or subscribe to the [RSS feed](/rss.xml). You can also reach out to me on [Twitter](https://twitter.com/thisizkp).
