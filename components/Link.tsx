...
export default function Link({ href, children, isIcon = false, 'aria-label': ariaLabel, className }: LinkProps) {
  const linkClasses = cn(
    ...
    isIcon && "inline-flex p-2 -m-2 text-gray-700 dark:text-zinc-300 hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-50 dark:focus:ring-offset-zinc-800 rounded-md transition-colors duration-300",
    className
  )
